  ...
  return (
    <>
      <div className="overflow-x-hidden border rounded-lg font-nunito">
        <p className="text-2xl font-semibold my-3">Latest Transactions</p>
        <table className="table">
          <thead>
            <tr>
              <th className="text-2xl font-semibold">Customer</th>
              <th className="text-2xl font-semibold">Date</th>
              <th className="text-2xl font-semibold">Amount</th>
              <th className="text-2xl font-semibold">Status</th>
            </tr>
          </thead>
